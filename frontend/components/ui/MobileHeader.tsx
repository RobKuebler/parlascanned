...
export function MobileHeader() {
  return (
    <header className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 h-[52px] bg-[#1E1B5E]">
      {/* Logo */}
      ...
      {/* Period selector — compact, right-aligned */}
